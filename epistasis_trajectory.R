...
mycol <- c(mycol,mycol)
a1<- read.table('analysis/trajectory_epistasis.txt',)
e1 <- read.table('analysis/trajectory_epistasis_std.txt')
png('figures/trajectory_epistasis.png',res=600,height=3000,width=3000)
par(mar=c(4,4,4,4))
